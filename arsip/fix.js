...
function kirimWA() {
    ...
    if ($('#whatsapp .nama').val() == '') { // Cek Nama
        ...
        var tujuan = $('#whatsapp .tujuan').val(),
            ...
            judul = $('#whatsapp .checkoutInfo .infotitle').text(),
            info = $('#whatsapp .Produkinfo').text(),
        ...
        $(this).attr('href', url_wa + '?phone=62 ' + tujuan + '&text=Halo admin' + ' saya mau beli *' + judul + '.* %0A%0A' + info + '_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _%0A%0A' + '*Metode Pembayaran :*%0A' + pembayaran + '%0A%0A' + '*Alamat:*%0A' + alamat + '%0A' + 'Provinsi ' + provinsi + '%0A' + kota + ' - Kec. ' + kecamatan + '%0A%0A' + 'A/n.%0A*' + nama + '* ( ' + nohp + ' )%0A%0Avia ' + via_url);
        var w = 960,
            h = 540,
